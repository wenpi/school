...
class Ccc_Third_Json {
    ...
    function decode($text, $type = 0) { // 默认type=0返回obj,type=1返回array
        ...
        if (function_exists('json_decode')) {
            return Ccc_Third_Filter::getInstance()->filterObj(json_decode(stripslashes($text), $type));
        }
        ...
        return Ccc_Third_Filter::getInstance()->filterObj($result);
    }
