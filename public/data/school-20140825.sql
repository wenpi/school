...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='班级表';

/*Data for the table `sch_classes` */

insert  into `sch_classes`(`class_id`,`sch_class_type_id`,`sch_class_type_name`,`property`,`sch_teacher_id`,`sch_teacher_no`,`sch_teacher_name`,`class_no`,`class_name`,`amount`,`class_minute`,`class_address`,`class_time`,`open_date`,`comments`,`status`,`merge_class_ids`,`add_user_id`,`add_time_int`,`update_user_id`,`update_time_int`,`is_delete`) values (1,1,'小班',0,1,001,'吴涛',01,'test1',0,0,'','0000-00-00 00:00:00','0000-00-00','',2,'',1,1408546353,0,0,0),(2,1,'小班',0,0,000,'',02,'test2',0,0,'','0000-00-00 00:00:00','0000-00-00','',2,'',1,1408546364,0,0,0),(3,3,'大班',1,1,001,'吴涛',03,'test_merge',0,0,'','2014-08-04 21:29:00','0000-00-00','',1,'2,1',1,1408546425,1,1408965494,0);
...
insert  into `sch_teachers`(`teacher_id`,`sch_class_id`,`ad_user_type_id`,`sch_job_id`,`en_name`,`cn_name`,`teacher_no`,`sex`,`birthday`,`address`,`id_type`,`id_number`,`phone`,`mobile_phone`,`email`,`photo_name`,`job_date`,`bargain_start_date`,`bargain_end_date`,`bargain_count`,`leave_date`,`leave_reason`,`graduate_school`,`graduate_date`,`graduate_specialty`,`status`,`max_education`,`add_user_id`,`add_time_int`,`update_user_id`,`update_time_int`,`is_delete`) values (1,0,2,2,'','吴涛',001,1,'2014-08-12','北京',0,'1234567','','13810769071','','','2014-08-05','0000-00-00','0000-00-00',0,'0000-00-00','','','0000-00-00','',1,0,1,1408461024,1,1408461779,0);
