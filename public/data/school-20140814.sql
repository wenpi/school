...
insert  into `sch_classes`(`class_id`,`sch_teacher_id`,`sch_teacher_no`,`sch_teacher_name`,`class_number`,`property`,`class_no`,`class_name`,`amount`,`class_minute`,`class_address`,`class_time`,`open_date`,`comments`,`status`,`add_user_id`,`add_time_int`,`update_user_id`,`update_time_int`,`is_delete`) values (1,0,00000000,'',001,0,01,'test',50,120,'北京','2014-08-04 18:04:00','2014-08-05','test',1,1,1407665056,1,1407941274,0),(2,0,00000000,'',102,1,02,'test1',1,11,'1','2014-08-12 18:54:00','2014-08-05','tret',1,1,1407668055,1,1408026274,0);
...
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='特长班与学生映射表';

/*Data for the table `sch_specialclass_student` */

insert  into `sch_specialclass_student`(`sepcialclass_student_id`,`sch_class_id`,`sch_student_id`) values (12,2,4);
...
insert  into `sch_students`(`student_id`,`sch_class_id`,`en_name`,`cn_name`,`student_no`,`sex`,`birthday`,`address`,`id_type`,`id_number`,`photo_name`,`entrance_date`,`graduate_date`,`school_status`,`add_user_id`,`add_time_int`,`update_user_id`,`update_time_int`,`is_delete`) values (1,1,'test','吴涛',001,0,'2014-08-05','北京',0,'123123123','1.jpg','0000-00-00','0000-00-00',0,0,1407316411,1,1407390352,0),(2,0,'','吴涛1',000,0,NULL,'',0,'','',NULL,NULL,0,0,0,0,0,0),(3,0,'','吴涛2',000,0,NULL,'',0,'','',NULL,NULL,0,0,0,0,0,0),(4,0,'','吴涛3',000,0,NULL,'',0,'','',NULL,NULL,0,0,0,0,0,0);
