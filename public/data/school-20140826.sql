...
CREATE TABLE `admin_user_type` (
  `user_type_id` int(9) NOT NULL AUTO_INCREMENT COMMENT '用户类别编号',
  `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0-无1-教工2-学生3-其他',
  `type_number` int(1) unsigned zerofill NOT NULL DEFAULT '0' COMMENT '用户类别编码',
  `type_name` varchar(50) NOT NULL DEFAULT '' COMMENT '用户类别名称',
  `comments` text COMMENT '描述',
...
insert  into `admin_user_type`(`user_type_id`,`type`,`type_number`,`type_name`,`comments`,`is_delete`) values (1,1,1,'校长',NULL,0),(2,1,2,'教师',NULL,0),(3,2,3,'学生',NULL,0),(4,3,4,'厨师',NULL,0),(5,3,5,'司机',NULL,0),(6,3,6,'保育员',NULL,0),(7,3,7,'家长',NULL,0),(8,3,8,'保安',NULL,0),(9,3,9,'保洁员',NULL,0);
...
/*Table structure for table `sch_class_type` */

DROP TABLE IF EXISTS `sch_class_type`;

CREATE TABLE `sch_class_type` (
  `class_type_id` int(9) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `class_type_name` varchar(20) NOT NULL DEFAULT '' COMMENT '类型名称',
  `level` tinyint(1) NOT NULL DEFAULT '0' COMMENT '等级[数字越高等级越高]',
  `comments` text COMMENT '描述',
  `is_delete` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除（0-否1-是）',
  PRIMARY KEY (`class_type_id`,`level`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

/*Data for the table `sch_class_type` */

insert  into `sch_class_type`(`class_type_id`,`class_type_name`,`level`,`comments`,`is_delete`) values (1,'小班',1,NULL,0),(2,'中班',2,NULL,0),(3,'大班',3,NULL,0);
...
CREATE TABLE `sch_classes` (
  ...
  `sch_class_type_id` int(9) NOT NULL COMMENT '班级类型编号',
  `sch_class_type_name` varchar(20) NOT NULL DEFAULT '' COMMENT '班级类型名称',
  `property` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0-普通班1-特长班',
  `sch_teacher_id` int(9) NOT NULL DEFAULT '0' COMMENT '班主任（授课教师）编号',
  `sch_teacher_no` int(3) unsigned zerofill NOT NULL DEFAULT '000' COMMENT '教师工号',
  `sch_teacher_name` varchar(64) DEFAULT '' COMMENT '教师名称',
  `class_no` int(2) unsigned zerofill NOT NULL DEFAULT '00' COMMENT '班号[编号]',
  ...
  `merge_class_ids` varchar(1500) NOT NULL DEFAULT '' COMMENT '合并的班级编号[以逗号隔开]',
...
insert  into `sch_classes`(`class_id`,`sch_class_type_id`,`sch_class_type_name`,`property`,`sch_teacher_id`,`sch_teacher_no`,`sch_teacher_name`,`class_no`,`class_name`,`amount`,`class_minute`,`class_address`,`class_time`,`open_date`,`comments`,`status`,`merge_class_ids`,`add_user_id`,`add_time_int`,`update_user_id`,`update_time_int`,`is_delete`) values (1,1,'小班',0,1,001,'吴涛',01,'test1',0,0,'','0000-00-00 00:00:00','0000-00-00','',2,'',1,1408546353,0,0,0),(2,1,'小班',0,0,000,'',02,'test2',0,0,'','0000-00-00 00:00:00','0000-00-00','',2,'',1,1408546364,0,0,0),(3,3,'大班',1,1,001,'吴涛',03,'test_merge',0,0,'','2014-08-04 21:29:00','0000-00-00','',2,'2,1',1,1408546425,1,1409064480,0),(4,0,'',0,1,001,'吴涛',04,'test_merge1',0,0,'','0000-00-00 00:00:00','0000-00-00','',1,'',1,1409063423,0,0,1),(5,1,'小班',0,1,001,'吴涛',05,'tet',0,0,'','0000-00-00 00:00:00','0000-00-00','',2,'',1,1409064499,0,0,0),(6,1,'小班',0,1,001,'吴涛',06,'testtttt',0,0,'','0000-00-00 00:00:00','0000-00-00','',2,'5,3',1,1409064647,0,0,0),(7,1,'小班',0,0,000,'',07,'dddd',0,0,'','0000-00-00 00:00:00','0000-00-00','',2,'',1,1409064879,0,0,0),(8,1,'小班',0,0,000,'',08,'sss',0,0,'','0000-00-00 00:00:00','0000-00-00','',1,'7,6',1,1409065063,0,0,0);
...
insert  into `sch_job`(`job_id`,`job_level`,`job_name`,`comments`,`is_delete`) values (1,0,'专任教师','',0),(2,0,'职员','',0),(3,0,'教辅人员','',0),(4,0,'工勤人员','',1);
...
CREATE TABLE `sch_message_send` (
  ...
  `content` varchar(2000) NOT NULL DEFAULT '' COMMENT '短信内容',
  `receive_user_ids` varchar(2000) NOT NULL DEFAULT '' COMMENT '接收人编号（多个请以逗号隔开）',
  `receive_user_nos` varchar(2000) NOT NULL DEFAULT '' COMMENT '接收人工号（多个请以逗号隔开）',
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='短信发送表';

/*Data for the table `sch_message_send` */

insert  into `sch_message_send`(`message_send_id`,`type`,`title`,`content`,`receive_user_ids`,`receive_user_nos`,`receive_user_names`,`receive_mobile_phones`,`send_user_id`,`send_user_name`,`send_time_type`,`send_time_int`,`send_result`,`is_delete`) values (1,1,'ddddddddddddddddddddddddddddddddddddddddsfasdfadsf','sdfasdfadsfdsfadsfadsfadsfadsfadsfadfsadfsadsfadsf','1,2','001,002','吴涛,吴涛1','13810769072,13810769071',1,'admin',0,0,1,0),(2,1,'顶顶顶顶顶顶顶顶dddddddddddddddddddddddddddddddddddddddddd','&amp;lt;script&amp;gt;ddddddddddddddd&amp;lt;/script&amp;gt;','1,2','001,002','吴涛,吴涛1','13810769072,13810769071',1,'admin',0,0,1,0);
...
CREATE TABLE `sch_money_config` (
  ...
  `sch_class_no` int(2) unsigned zerofill NOT NULL DEFAULT '00' COMMENT '班级号',
  `sch_term_id` int(9) NOT NULL DEFAULT '0' COMMENT '学期编号 ',
  `sch_term_name` varchar(20) NOT NULL DEFAULT '' COMMENT '学期名称',
  `month` int(2) NOT NULL DEFAULT '0' COMMENT '月份',
  `sch_money_project_id` int(9) NOT NULL DEFAULT '0' COMMENT '收费项目编号',
  `sch_money_project_name` varchar(50) NOT NULL DEFAULT '' COMMENT '收费项目名称',
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='费用配置表';

/*Data for the table `sch_money_config` */

insert  into `sch_money_config`(`money_config_id`,`sch_class_id`,`sch_class_name`,`sch_class_no`,`sch_term_id`,`sch_term_name`,`month`,`sch_money_project_id`,`sch_money_project_name`,`money`,`comments`,`add_user_id`,`add_time_int`,`update_user_id`,`update_time_int`,`is_delete`) values (1,1,'test',01,1,'暑假培训数学',1,1,'testte','111.00','ddddddddddd',1,1408349854,1,1408354051,0);
...
CREATE TABLE `sch_money_data` (
  ...
  `sch_class_id` int(9) NOT NULL DEFAULT '0' COMMENT '班级编号[冗余]',
  `sch_class_no` int(2) unsigned zerofill NOT NULL DEFAULT '00' COMMENT '班级班号',
  `sch_class_name` varchar(20) NOT NULL DEFAULT '' COMMENT '班级名称',
  `sch_term_id` int(9) NOT NULL DEFAULT '0' COMMENT '学期编号[冗余]',
  `sch_term_name` varchar(50) NOT NULL DEFAULT '' COMMENT '学期名称',
  `money_number` bigint(13) unsigned zerofill NOT NULL DEFAULT '0000000000000' COMMENT '费用单号（日期+班级号二位+流水号三位）',
  ...
  `sch_money_project_name` varchar(50) NOT NULL DEFAULT '0' COMMENT '费用项目名称',
  `money` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '应交金额',
  `realy_money` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '实交金额',
...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='幼儿园费用表';

/*Data for the table `sch_money_data` */

insert  into `sch_money_data`(`money_data_id`,`sch_class_id`,`sch_class_no`,`sch_class_name`,`sch_term_id`,`sch_term_name`,`money_number`,`money_date`,`type`,`money_name`,`sch_money_project_id`,`sch_money_project_name`,`money`,`realy_money`,`comments`,`add_user_id`,`add_time_int`,`update_user_id`,`update_time_int`,`is_delete`) values (1,1,01,'test1',1,'暑假培训数学',2014080101001,'2014-08-01',0,'test',1,'testte','111.00','100.00','test',1,1408580372,0,0,0),(2,1,01,'test1',1,'暑假培训数学',2014080101002,'2014-08-01',0,'test1',1,'testte','0.00','100.00','test',1,1408580637,1,1408585463,0),(3,1,01,'test1',1,'暑假培训数学',2014080701001,'2014-08-07',1,'test',1,'testte','111.00','111.00','111',1,1408668817,0,0,0),(4,1,01,'test1',1,'暑假培训数学',2014080101003,'2014-08-01',0,'test',1,'testte','111.00','100.00','test',1,1408927798,0,0,0);
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='费用项目表';

/*Data for the table `sch_money_projects` */

insert  into `sch_money_projects`(`money_project_id`,`money_project_name`,`comments`,`is_delete`) values (1,'testte',NULL,0);
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='家长表';

/*Data for the table `sch_parents` */

insert  into `sch_parents`(`parent_id`,`sch_student_id`,`en_name`,`cn_name`,`parent_no`,`parent_named`,`phone`,`mobile_phone`,`is_message`,`is_delete`) values (1,1,'wutao','吴涛',000,1,'','13810769072',1,0),(2,1,'','',000,1,'','',0,0),(3,1,'','',000,1,'','',0,0),(4,1,'','',000,1,'','',0,0),(5,2,'wutao1','吴涛1',000,1,'','13810769071',1,0);
...
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='特长班与学生映射表';

/*Data for the table `sch_specialclass_student` */

insert  into `sch_specialclass_student`(`sepcialclass_student_id`,`sch_class_id`,`sch_student_id`) values (15,3,2),(13,2,4);
...
CREATE TABLE `sch_student_money_data` (
  `student_money_data_id` int(9) NOT NULL AUTO_INCREMENT COMMENT '学生费用编号',
  ...
  `sch_term_name` varchar(50) NOT NULL DEFAULT '' COMMENT '学期名称',
  `sch_student_id` int(9) NOT NULL DEFAULT '0' COMMENT '学生编号',
  `sch_student_no` int(2) unsigned zerofill NOT NULL DEFAULT '00' COMMENT '学生学号',
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='学生费用记录表';

/*Data for the table `sch_student_money_data` */

insert  into `sch_student_money_data`(`student_money_data_id`,`sch_money_data_id`,`sch_class_id`,`sch_class_no`,`sch_class_name`,`sch_term_id`,`sch_term_name`,`sch_student_id`,`sch_student_no`,`sch_student_name`,`status`,`is_delete`) values (1,3,1,1,'test1',1,'暑假培训数学',1,01,'吴涛',1,0),(2,4,1,1,'test1',1,'暑假培训数学',1,01,'吴涛',1,0);
...
CREATE TABLE `sch_students` (
  ...
  `en_name` varchar(50) NOT NULL DEFAULT '' COMMENT '英文名字',
  `cn_name` varchar(50) NOT NULL DEFAULT '' COMMENT '中文名字',
  `student_no` int(3) unsigned zerofill NOT NULL DEFAULT '000' COMMENT '学号[编号]',
  ...
  `quit_date` date DEFAULT NULL COMMENT '退学日期',
  `school_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '学籍状态（0-在读1-毕业2-退学）',
...
insert  into `sch_students`(`student_id`,`sch_class_id`,`en_name`,`cn_name`,`student_no`,`sex`,`birthday`,`address`,`id_type`,`id_number`,`photo_name`,`entrance_date`,`graduate_date`,`quit_date`,`school_status`,`add_user_id`,`add_time_int`,`update_user_id`,`update_time_int`,`is_delete`) values (1,1,'test','吴涛',001,0,'2014-08-05','北京',0,'123123123','1.jpg','0000-00-00','0000-00-00','0000-00-00',1,0,1407316411,1,1408499273,0),(2,1,'','吴涛1',002,0,NULL,'',0,'','',NULL,NULL,NULL,0,0,0,0,0,0),(3,0,'','吴涛2',000,0,NULL,'',0,'','',NULL,NULL,NULL,0,0,0,0,0,0),(4,0,'','吴涛3',000,0,NULL,'',0,'','',NULL,NULL,NULL,0,0,0,0,0,0);
...
CREATE TABLE `sch_subjects` (
  ...
  `sch_class_id` int(9) NOT NULL DEFAULT '0' COMMENT '班级编号',
  `sch_class_no` int(2) unsigned zerofill NOT NULL DEFAULT '00' COMMENT '班号',
  `sch_class_name` varchar(30) NOT NULL DEFAULT '' COMMENT '班级名称',
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='科目表（语文/数学等）';

/*Data for the table `sch_subjects` */

insert  into `sch_subjects`(`subject_id`,`type_id`,`sch_class_id`,`sch_class_no`,`sch_class_name`,`subject_name`,`comments`,`add_user_id`,`add_time_int`,`is_delete`) values (1,1,8,08,'sss','dddddd','dd',0,0,0),(2,0,8,08,'sss','dddd','',0,0,0);
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='教工考勤表';

/*Data for the table `sch_teacher_attendance` */

insert  into `sch_teacher_attendance`(`teacher_attendance_id`,`teacher_id`,`teacher_no`,`teacher_name`,`come_time`,`leave_time`,`reason`,`attendance_date`,`is_delete`) values (1,1,001,'吴涛','2014-08-04 00:00:00','2014-08-04 00:00:00','','2014-08-04',1),(2,1,001,'吴涛','2014-08-12 00:00:00','2014-08-12 00:00:00','','2014-08-12',1),(3,1,001,'吴涛','2014-08-04 19:00:00','2014-08-04 18:30:00','','2014-08-04',0);
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='教工奖惩表';

/*Data for the table `sch_teacher_deal_data` */

insert  into `sch_teacher_deal_data`(`teacher_deal_data_id`,`teacher_id`,`teacher_no`,`teacher_name`,`deal_date`,`type_id`,`deal_name`,`deal_reason`,`deal_user_id`,`deal_real_name`,`is_delete`) values (1,1,001,'吴涛','2014-08-11',1,'test','',1,'最高级管理员',0);
...
CREATE TABLE `sch_teachers` (
  ...
  `sch_class_id` int(9) NOT NULL DEFAULT '0' COMMENT '班级编号',
  `ad_user_type_id` int(9) NOT NULL DEFAULT '0' COMMENT '教工类别编号',
  `sch_job_id` int(9) NOT NULL DEFAULT '0' COMMENT '岗位编号',
  `en_name` varchar(50) NOT NULL DEFAULT '' COMMENT '英文名字',
  `cn_name` varchar(50) NOT NULL DEFAULT '' COMMENT '中文名字',
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='教工表';

/*Data for the table `sch_teachers` */

insert  into `sch_teachers`(`teacher_id`,`sch_class_id`,`ad_user_type_id`,`sch_job_id`,`en_name`,`cn_name`,`teacher_no`,`sex`,`birthday`,`address`,`id_type`,`id_number`,`phone`,`mobile_phone`,`email`,`photo_name`,`job_date`,`bargain_start_date`,`bargain_end_date`,`bargain_count`,`leave_date`,`leave_reason`,`graduate_school`,`graduate_date`,`graduate_specialty`,`status`,`max_education`,`add_user_id`,`add_time_int`,`update_user_id`,`update_time_int`,`is_delete`) values (1,8,2,2,'','吴涛',001,1,'2014-08-12','北京',0,'1234567','','13810769071','','','2014-08-05','0000-00-00','0000-00-00',0,'0000-00-00','','','0000-00-00','',1,0,1,1408461024,1,1409067320,0);
...
CREATE TABLE `sch_term_config` (
  ...
  `is_delete` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除（0-不删除1-删除）',
  PRIMARY KEY (`term_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='学期配置表';

/*Data for the table `sch_term_config` */

insert  into `sch_term_config`(`term_id`,`year`,`term_name`,`type`,`start_date`,`end_date`,`comments`,`is_delete`) values (1,2014,'暑假培训数学',1,'2014-08-01','2014-08-31','上帝发誓地方\r\nsdfadsf\r\ndsf\r\nadsf\r\ndf\r\nadsf\r\nads\r\nf上的发大水法的说法第三方；啊打发打发；的分； 阿德发的',0);
