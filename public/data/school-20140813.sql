...
insert  into `sch_classes`(`class_id`,`sch_teacher_id`,`sch_teacher_no`,`sch_teacher_name`,`class_number`,`property`,`class_no`,`class_name`,`amount`,`class_minute`,`class_address`,`class_time`,`open_date`,`comments`,`status`,`add_user_id`,`add_time_int`,`update_user_id`,`update_time_int`,`is_delete`) values (1,0,00000000,'',001,0,01,'test',50,120,'北京','2014-08-04 18:04:00','2014-08-05','test',1,1,1407665056,1,1407941274,0),(2,0,00000000,'',102,1,02,'test1',1,11,'1','2014-08-12 18:54:00','2014-08-05','tret',1,1,1407668055,1,1407941735,0);
